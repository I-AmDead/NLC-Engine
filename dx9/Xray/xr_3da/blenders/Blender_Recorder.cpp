...
#ifndef _EDITOR
#ifdef USE_R1// RENDER==R_R1
	if (!ps_r2_engine_flags.test(R1FLAG_DETAIL_TEXTURES))
		bDetail = FALSE;
#endif
#endif
...
#ifndef _EDITOR
#ifndef USE_R1// RENDER!=R_R1
		//	Detect the alowance of detail bump usage here.
		if (  !(/*RImplementation.o.advancedpp &&*/ ps_r2_engine_flags.test(R2FLAG_DETAIL_BUMP) ) )
		{
