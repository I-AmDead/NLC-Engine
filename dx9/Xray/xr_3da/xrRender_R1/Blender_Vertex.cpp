...
void	CBlender_Vertex::Save	( IWriter& fs	)
{
	...
	I.ID = 0; strcpy(I.str,"NO_TESS");	fs.w		(&I,sizeof(I));
	I.ID = 1; strcpy(I.str,"TESS_PN");	fs.w		(&I,sizeof(I));
	I.ID = 2; strcpy(I.str,"TESS_HM");	fs.w		(&I,sizeof(I));
	I.ID = 3; strcpy(I.str,"TESS_PN+HM");	fs.w		(&I,sizeof(I));
}
