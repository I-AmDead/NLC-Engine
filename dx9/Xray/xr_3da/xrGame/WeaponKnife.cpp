...
//	HUD_SOUND::LoadSound(section, "snd_draw", m_sndShow, ESoundTypes(SOUND_TYPE_ITEM_TAKING));
//	HUD_SOUND::LoadSound(section, "snd_holster", m_sndHide, ESoundTypes(SOUND_TYPE_ITEM_HIDING));
...
//	HUD_SOUND::PlaySound(m_sndHide, H_Parent()->Position(), H_Parent(), b_hud_mode);
}
...
//	m_bPending				= true;
//	bool b_hud_mode = (Level().CurrentEntity() == H_Parent());
//	HUD_SOUND::PlaySound(m_sndShow, H_Parent()->Position(), H_Parent(), b_hud_mode);
}
