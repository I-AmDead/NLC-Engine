...
IC bool AllowedDefaultPool(LPCSTR name, UINT vmem_rest = 512 * 1048576)
{
	...
	bool name_check = (NULL == strstr(name, "~vmt\\") && NULL == strstr(name, "$user$") &&
					   ...
					   */
/*
	bool name_check = (strstr(name, "act\\") || strstr(name, "swmt\\") || strstr(name, "wpn\\") || strstr(name, "ston\\")
		|| strstr(name, "trees\\") || strstr(name, "mlt\\") || strstr(name, "crete\\")
		|| strstr(name, "amk\\") || strstr(name, "detail\\") || strstr(name, "door\\") || strstr(name, "grnd\\")	
		|| strstr(name, "veh\\") || strstr(name, "wall\\") || strstr(name, "wood\\")
		|| strstr(name, "briks\\") || strstr(name, "wind\\") || strstr(name, "wm\\")
		|| strstr(name, "artifact\\") || strstr(name, "tile\\") || strstr(name, "metro\\") || strstr(name, "floor\\")
		);
*/
