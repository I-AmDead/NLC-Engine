...
XRCORE_API const xr_string& __cdecl xra_sprintf (LPCSTR format, ...); 
extern "C"
{
	// alpet: использует те-же глобальные буферы, что и xra_sprintf, но удобна для экспорта в "чужие" DLL/EXE
