...
void _initialize_cpu(void)
{
    ...
    if (CPU::ID.feature&_CPU_FEATURE_MMX) strcat_s(features, ", MMX");
    if (CPU::ID.feature&_CPU_FEATURE_3DNOW) strcat_s(features, ", 3DNow!");
    if (CPU::ID.feature&_CPU_FEATURE_SSE) strcat_s(features, ", SSE");
    if (CPU::ID.feature&_CPU_FEATURE_SSE2) strcat_s(features, ", SSE2");
    if (CPU::ID.feature&_CPU_FEATURE_SSE3) strcat_s(features, ", SSE3");
    if (CPU::ID.feature&_CPU_FEATURE_SSSE3) strcat_s(features, ", SSSE3");
    if (CPU::ID.feature&_CPU_FEATURE_SSE4_1)strcat_s(features, ", SSE4.1");
    if (CPU::ID.feature&_CPU_FEATURE_SSE4_2)strcat_s(features, ", SSE4.2");
    if (CPU::ID.feature&_CPU_FEATURE_HTT) strcat_s(features, ", HTT");
