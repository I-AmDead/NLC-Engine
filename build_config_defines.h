...
// ==================================== Правки от K.D. =======================================
#define DETAIL_RADIUS				// alpet: включает правку дистанции отрисовки травы и плотности. Может влиять на производительность для слабых систем.
...
#define TORCH_SOUNDS			// звуки включения\выключения фонарика
//#define NUM_PHRASES				// нумерация фраз ответов как в ЗП