...
ENGINE_API float			psSunShaftsForce = 0.0f;

extern int			g_ErrorLineCount;
extern int			g_iTargetFPS;
ENGINE_API int			ps_r__Supersample			= 1;
ENGINE_API float	ps_r1_fog_luminance		= 1.1f;
ENGINE_API int		ps_r1_SoftwareSkinning	= 0;

ENGINE_API float	    g_up_speed_k				= 1.35;

ENGINE_API u32			ps_r3_msaa = 0;			//	=	0;
...
//	CMD3(CCC_Mask,		"rs_disable_objects_as_crows",&psDeviceFlags,	rsDisableObjectsAsCrows	);
	...
	CMD3(CCC_Mask,		"r1_detail_textures",	&ps_r2_engine_flags,		R1FLAG_DETAIL_TEXTURES);
	CMD3(CCC_Mask,		"r2_detail_bump",		&ps_r2_engine_flags,		R2FLAG_DETAIL_BUMP);
	CMD3(CCC_Mask,		"r3_clear_hud",			&ps_r2_engine_flags,		R3FLAG_CLEAR_HUD);
	//CMD3(CCC_Mask,		"r1_3d_static",			&ps_r2_engine_flags,		R1FLAG_3DSTATIC);
...
//	CMD4(CCC_Integer,	"rs_ib_size",			&rsDIB_Size,		32,		4096);
	...
	CMD4(CCC_Float,		"r2_sun_shafts_force",			&psSunShaftsForce,		0.0f, 0.99f);
