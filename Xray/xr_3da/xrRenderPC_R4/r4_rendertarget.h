...
public:
	...
	ref_rt						rt_Generic;
	ref_rt						rt_Generic_prev0;
	ref_rt						rt_Generic_prev1;
	ref_rt						rt_Hud_prev0;
	ref_rt						rt_Hud_prev1;
	ref_rt						rt_Hud_ZB;
...
//	ref_rt						rt_ScenePrev;
//	ref_rt						rt_Reflect;
	ref_rt						rt_UI3dStatic;
	ref_rt						rt_UI3dStatic_prev0;
	ref_rt						rt_UI3dStatic_prev1;
	ref_rt						rt_UI3dStatic_prev2;
	ref_rt						rt_UI3dStatic_prev3;

	//ref_rt						rt_UI3dStatic_r;
	//ref_rt						rt_UI3dStatic_ZB;
	//ID3D11RenderTargetView*		rt_UI3dStatic_TAA[4];
	//ref_texture					t_3dstatic_taa;
