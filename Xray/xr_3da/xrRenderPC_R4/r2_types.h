...
#define		r2_RT_scene		"$user$scene"
//#define		r2_RT_scene_prev		"$user$scene_prev"
//#define		r2_RT_reflect		"$user$reflect"
#define		r2_RT_3dstatic			"$user$3dstatic"
#define		r2_RT_3dstatic_prev0		"$user$3dstatic_prev0"
#define		r2_RT_3dstatic_prev1		"$user$3dstatic_prev1"
#define		r2_RT_3dstatic_prev2		"$user$3dstatic_prev2"
#define		r2_RT_3dstatic_prev3		"$user$3dstatic_prev3"
#define		r2_RT_3dstatic_r		"$user$3dstatic_r"
#define		r2_RT_3dstatic_ZB		"$user$3dstatic_zb"
...
#define		r2_RT_generic_prev0		"$user$generic_prev0"
#define		r2_RT_generic_prev1		"$user$generic_prev1"
#define		r2_RT_hud_prev0		"$user$hud_prev0"
#define		r2_RT_hud_prev1		"$user$hud_prev1"
#define		r2_RT_hud_ZB		"$user$hud_zb"
