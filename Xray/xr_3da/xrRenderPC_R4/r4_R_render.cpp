...
void CRender::render_menu	()
{
	...
	// Distort
	{
		...
		Target->u_setrt(Target->rt_Generic,0,0,HW.pBaseZB);		// Now RT is a distortion mask
		HW.pContext->ClearRenderTargetView(Target->rt_Generic->pRT, ColorRGBA);		
...
//.	VERIFY					(g_pGameLevel && g_pGameLevel->pHUD);
	...
	if ( ps_r2_engine_flags.test(R3FLAG_CLEAR_HUD) )
	{
		Target->phase_scene_begin				();
		r_dsgraph_render_hud					(0);
		Target->phase_clear_hud					();
	}
