...
public:
	...
	enum
	{
		...
		MSAA_ATEST_DX10_1_NATIVE	= 0x1,
		MSAA_ATEST_DX10_1_ATOC		= 0x2,
	};
...
public:
	...
	virtual void					DoAsyncScreenshot			() { Target->DoAsyncScreenshot(); }
	...
	virtual BOOL					is_sun						();
	virtual void					phase_wet_rain() { /*Target->phase_wet_rain();*/ }
