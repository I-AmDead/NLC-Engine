...
#include "..\xr_3da\TextureDescrManager.h"
#include "..\xr_3da\TextureDescrManager.cpp"

#include "..\xr_3da\ETextureParams.h"
#include "..\xr_3da\ETextureParams.cpp"
...
void uber_shadow(CBlender_Compile& C, LPCSTR _vspec)
{
	...
	string256		vs,dt;
	strcpy_s		(dt,sizeof(dt),C.detail_texture?C.detail_texture:"");
