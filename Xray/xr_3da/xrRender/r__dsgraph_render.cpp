...
Fmatrix m_previous_hud;
//////////////////////////////////////////////////////////////////////////
// HUD render
void R_dsgraph_structure::r_dsgraph_render_hud	(u32 _priority)
{
	...
	RImplementation.set_taa_project_matrix();

	Device.mFullTransform.mul	(Device.mProject, Device.mView);
	RCache.set_xform_project	(Device.mProject);

	static Fmatrix		m_saved_viewproj_hud;

	// (new-camera) -> (world) -> (old_viewproj)
	Fmatrix	m_invview;	m_invview.invert(Device.mView);
	m_previous_hud.mul(m_saved_viewproj_hud, m_invview);
	m_saved_viewproj_hud.set(Device.mFullTransform);
