...
Fvector		ps_r1_3d_static_light_dir	= { -0.5f, -0.25f, -1.0f };
...
public		:
	...
	virtual void	Execute	(LPCSTR args)
	{
		...
		DEV->_GetMemoryUsage(m_base, c_base, m_lmaps, c_lmaps);
...
#endif // DEBUG
	Fvector	ld3d_min, ld3d_max;
	ld3d_min.set			(-1.f,-1.f,-1.f);
	ld3d_max.set			(1.f,1.f,1.f);
	CMD4(CCC_Vector3,	"r1_3d_static_light_dir",		&ps_r1_3d_static_light_dir,		ld3d_min, ld3d_max	);
...
//	CMD3(CCC_Mask,		"r2_exp_donttest_uns",	&ps_r2_ls_flags,			R2FLAG_EXP_DONT_TEST_UNSHADOWED);
	...
	CMD3(CCC_Mask,		"r2_hemi_cop",			&ps_r2_ls_flags,			R2FLAG_HEMI_COP);
	CMD3(CCC_Mask,		"r1_3d_static_icon_create",		&ps_r2_ls_flags,			R1FLAG_3DSTATIC_CREATE);
...
//	CMD3(CCC_Mask,		"r2_sun_shafts",				&ps_r2_ls_flags,			R2FLAG_SUN_SHAFTS);
	...
	CMD3(CCC_Mask,		"r2_reflections",				&ps_r2_ls_flags,			R2FLAG_REFLECTIONS);
...
//	CMD5(CCC_PP,		"r2_reflections_quality",		&ps_refl_quality,			dual_quality_token,			&ps_r2_pp_flags,			R2PP_FLAG_REFLECTIONS);
