...
rnd_motion*	rnd_motion::	setup		( CKinematicsAnimated* k, LPCSTR s )
{
	VERIFY( k );
	VERIFY( s );
...
/*
void type_motion::set_motion( CKinematicsAnimated* k, CInifile* ini, LPCSTR type, LPCSTR dir, edirection id_dir )
{
...
void type_motion::set_motion( CKinematicsAnimated* k, u16 id_motion, LPCSTR dir_anim )
{
...
type_motion* type_motion::setup( CKinematicsAnimated* k, CInifile* ini, LPCSTR section, LPCSTR type )
{
