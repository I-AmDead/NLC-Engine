...
void CStalkerAnimationPair::play_global_animation	(CKinematicsAnimated *skeleton_animated, PlayCallback callback, const u32 &bone_part, const bool &use_animation_movement_control, const bool &local_animation, bool mix_animations)
#endif
{
	//DBG_OpenCashedDraw();
...
#ifndef USE_HEAD_BONE_PART_FAKE
void CStalkerAnimationPair::play			(CKinematicsAnimated *skeleton_animated, PlayCallback callback, const bool &use_animation_movement_control, const bool &local_animation, bool continue_interrupted_animation, bool mix_animations)
#else
void CStalkerAnimationPair::play			(CKinematicsAnimated *skeleton_animated, PlayCallback callback, const bool &use_animation_movement_control, const bool &local_animation, bool continue_interrupted_animation, const u32 &bone_part, bool mix_animations)
#endif
{
	VERIFY					(animation());
	if (actual()) {
...
bool CStalkerAnimationPair::use_animation_movement_control	(CKinematicsAnimated *skeleton_animated, MotionID const &motion_id) const
{
