...
private:
			...
			void			play_global_animation	(CKinematicsAnimated *skeleton_animated, PlayCallback callback, const u32 &bone_part, const bool &use_animation_movement_control, const bool &local_animation, bool mix_animations);
#endif // USE_HEAD_BONE_PART_FAKE
...
public:
#ifndef USE_HEAD_BONE_PART_FAKE
			void			play					(CKinematicsAnimated *skeleton_animated, PlayCallback callback, const bool &use_animation_movement_control, const bool &local_animation, bool continue_interrupted_animation = true, bool mix_animations = true);
#else // USE_HEAD_BONE_PART_FAKE
			void			play					(CKinematicsAnimated *skeleton_animated, PlayCallback callback, const bool &use_animation_movement_control, const bool &local_animation, bool continue_interrupted_animation = true, const u32 &bone_part = all_bone_parts, bool mix_animations = true);
#endif // USE_HEAD_BONE_PART_FAKE
...
public:
	...
	IC		void			target_matrix			(Fmatrix const &matrix);
			...
			bool			use_animation_movement_control	(CKinematicsAnimated *skeleton_animated, MotionID const &motion_id) const;
};
