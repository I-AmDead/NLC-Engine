...
void CWeaponMagazined::Load(LPCSTR section)
{
	...
	m_sounds.LoadSound(section, "snd_SightsUp", "sndSightsUp", true, m_eSoundSightsUp);		//added by Daemonion for ironsight audio in weapon parameters - sights being raised
	m_sounds.LoadSound(section, "snd_SightsDown", "sndSightsDown", true, m_eSoundSightsDown);	//added by Daemonion for ironsight audio in weapon parameters - sights being lowered
...
void CWeaponMagazined::UpdateSounds()
{
	...
	m_sounds.SetPosition("sndSightsUp", P);
	m_sounds.SetPosition("sndSightsDown", P);
}
...
void CWeaponMagazined::OnZoomIn()
{
	...
	if (pActor)
	{
		...
		m_sounds.StopSound("sndSightsUp");													//daemonion - iron sight audio - sights being raised
		m_sounds.StopSound("sndSightsDown");												//									
		bool b_hud_mode = (Level().CurrentEntity() == H_Parent());							//
		m_sounds.PlaySound("sndSightsUp", H_Parent()->Position(), H_Parent(), b_hud_mode);	//--END	
...
void CWeaponMagazined::OnZoomOut()
{
	...
	m_sounds.StopSound("sndSightsUp");													//daemonion - iron sight audio - sights being lowered
	m_sounds.StopSound("sndSightsDown");												//									
	bool b_hud_mode = (Level().CurrentEntity() == H_Parent());							//
	m_sounds.PlaySound("sndSightsDown", H_Parent()->Position(), H_Parent(), b_hud_mode);//--END
