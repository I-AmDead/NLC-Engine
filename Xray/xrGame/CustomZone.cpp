...
//////////////////////////////////////////////////////////////////////////
	...
	//gnzi	m_zone_flags.set	(eAffectPickDOF, pSettings->r_bool (section, "pick_dof_effector"));
	m_zone_flags.set(eAffectPickDOF, false);
}
...
void CCustomZone::UpdateWorkload	(u32 dt)
{
	...
	if (Level().CurrentEntity()) {
		...
		if (m_effector && EnableEffector())
			m_effector->Update(m_fDistanceToCurEntity, m_eHitTypeBlowout);
	}
