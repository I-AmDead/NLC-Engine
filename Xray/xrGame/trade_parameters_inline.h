...
{
	buy_item_condition_factor = READ_IF_EXISTS(pSettings, r_float, section, "buy_item_condition_factor", 0.65f);
	buy_artefact_condition_factor = READ_IF_EXISTS(pSettings, r_float, section, "buy_artefact_condition_factor", 0.3f);
}
