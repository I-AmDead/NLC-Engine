...
animation_movement_controller::animation_movement_controller( Fmatrix *_pObjXForm, const Fmatrix &inital_pose, CKinematics* _pKinematicsC, CBlend* b ):
m_startObjXForm( inital_pose ), 
m_pObjXForm( *_pObjXForm ),
m_pKinematicsC( _pKinematicsC ),
m_pKinematicsA( smart_cast<CKinematicsAnimated*>( _pKinematicsC ) ),
...
static void get_animation_root_position( Fmatrix &pos, CKinematics* K, CKinematicsAnimated* KA, CBlend *control_blend )
{
	VERIFY( KA );
	VERIFY( K );
