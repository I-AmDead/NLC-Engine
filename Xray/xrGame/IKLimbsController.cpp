...
void	y_shift_bones( CKinematics* K, float shift )
{
...
{		
		CKinematics *skeleton_animated = m_object->Visual()->dcast_PKinematics( );
		VERIFY( skeleton_animated );
...
void CIKLimbsController::Calculate( )
{
	...
	CKinematics *K = m_object->Visual()->dcast_PKinematics( );
