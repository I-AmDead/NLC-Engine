...
#define SCRIPT_VARS_CHUNK_DATA		0x000D // alpet: дл€ сохранени€ переменных
...
namespace ALife {
	...
	//возможность подключени€ аддонов
	enum EWeaponAddonStatus{
		eAddonDisabled				= 0,	//нельз€ присоеденить
		eAddonPermanent				= 1,	//посто€нно подключено по умолчанию
		eAddonAttachable			= 2		//можно присоедин€ть
	};
