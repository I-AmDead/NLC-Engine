...
#include "phdebug.h"
#endif
moving_bones_snd_player::moving_bones_snd_player( CKinematics *K, CInifile* ini, LPCSTR section, const Fmatrix &object  ):
	bone_id( BI_NONE ),
	min_factor( -FLT_MAX ),
	max_factor( -FLT_MAX ),
...
moving_bones_snd_player* create_moving_bones_snd_player( CInifile* ini, CKinematics& K, const Fmatrix &obj  )
{
...
void moving_bones_snd_player::load( CKinematics &K, CInifile& ini, LPCSTR section, const Fmatrix &object )
{
