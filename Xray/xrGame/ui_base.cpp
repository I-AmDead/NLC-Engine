...
#if (USE_DX10) || (USE_DX11)
	RCache.set_Scissor(&r);
	StateManager.OverrideScissoring( &r?true:false, TRUE );
#else
	RCache.set_Scissor(&r);
#endif
}
...
//.	return;
...
#if (USE_DX10) || (USE_DX11)
	{
		...
		StateManager.OverrideScissoring( false, TRUE );
	}
#else
		RCache.set_Scissor(0);
#endif
	...
	StateManager.OverrideScissoring( &tgt?true:false, TRUE );
#else
	RCache.set_Scissor(&tgt);
#endif
	}
