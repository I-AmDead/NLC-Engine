...
CBlend	*PlayMotionByParts(CKinematicsAnimated* sa, MotionID motion_ID, BOOL bMixIn, PlayCallback Callback, LPVOID CallbackParam)
{
	CBlend	*ret = 0;
...
CBlend*	anim_script_callback::play_cycle( CKinematicsAnimated* sa,const shared_str& anim )
{
