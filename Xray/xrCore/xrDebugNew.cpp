...
#ifdef USE_BUG_TRAP
#	include "../../3rd party/bugtrap/bugtrap.h"						// for BugTrap functionality
    #ifdef __BORLANDC__
...
void SetupExceptionHandler	(const bool &dedicated)
{
	...
	BT_SetDialogMessage				(
		BTDM_INTRO2,
		"\
This is X-Ray Engine v1.0 crash reporting client. \
...
//			MiniDumpWithCodeSegs |
	...
	BT_SetSupportEMail		("soc-crash-report@stalker-game.com");
